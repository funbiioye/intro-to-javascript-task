...
function go(){
    ...
    document.getElementById("p1").innerHTML="The Number of vowels in Textbox is "+ ctr;
    document.getElementById("p2").innerHTML="The Number of consonant in Textbox is "+ ctr1;
}
